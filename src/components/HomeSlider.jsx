  ...
  const slides = [
    {
      ...
      title: "ADVANCED AI",
      title2: "SOFTWARE & ENTERPRISE",
      title3: "TECHNOLOGY SOLUTIONS",
      tags: ['UK-BASED', 'AI-POWERED', 'SECURE PLATFORMS'],
      slideNumber: '01'
    },
    {
      ...
      title2: "DIGITAL",
      title3: "ECOSYSTEMS",
      tags: ['METAVERSE', 'CYBERSECURITY', 'CLOUD-NATIVE'],
      slideNumber: '02'
    },
    {
      ...
      title2: "TECHNOLOGY",
      title3: "PARTNER",
      tags: ['ENTERPRISE GRADE', 'GLOBAL DELIVERY', 'SCALABLE'],
      slideNumber: '03'
    }
  ];
