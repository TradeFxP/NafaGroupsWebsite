          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className={`contact-info-wrapper ${isVisible ? 'animate-slide-from-left' : ''}`}>
              <div className="contact-info-card">
                ...
                <h4>London Office</h4>
                <p>Unit 7B, Cranbrook House, 61 Cranbrook Road,<br />Ilford, Essex, England, IG1 4PG</p>
              </div>
              ...
              <div className="contact-info-card">
                ...
                <h4>Dubai Office</h4>
                <p>908, 9th Floor, Fifty-One Tower, Marasi Drive,<br />Business Bay, Dubai, UAE</p>
              </div>
              ...
              <div className="contact-info-card">
                ...
                <h4>Call Us</h4>
                <p>
                  <a href="tel:+447444468968">+44 7444 468968</a>
                </p>
              </div>
              ...
              <div className="contact-info-card">
                ...
                <h4>Email Us</h4>
                <p>
                  <a href="mailto:info@nafagroups.com">info@nafagroups.com</a><br />
                  <a href="mailto:support@nafagroups.com">support@nafagroups.com</a>
                </p>
              </div>
            </div>
          </div>
