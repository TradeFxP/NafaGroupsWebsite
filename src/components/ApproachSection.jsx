        ...
        <div className="row">
          <div className="col-12 text-center mb-50">
            ...
            <p className={`section-description ${isVisible ? 'animate-fade-in-delayed' : ''}`}>
              A structured methodology for delivering secure, scalable enterprise technology
            </p>
          </div>
        </div>
        ...
        <div className="row mt-60">
          <div className="col-12">
            <div className={`approach-statement ${isVisible ? 'animate-scale-in' : ''}`}>
              ...
              <h3>Quality Engineering Meets AI Expertise</h3>
              <p>
                Our approach combines deep technology domain knowledge with world-class engineering practices. 
                From understanding business requirements to delivering enterprise-grade AI-powered systems, we ensure 
